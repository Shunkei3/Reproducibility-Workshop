...
+ How are the project folder organized?
+ Take a look at a code file. Why do you think code is written in `.qmd` file instead of `.R` file?
+ Check out the `writing` folder and see how the tables and figures are inserted into the report.
+ Check out the `main.qmd` file and see how the whole workflow is executed in an automated and traceable way.
:::
...
## Next Session: Practical tools for reproducibility

We will cover the practical tools in more detail in the next session! Do you have any suggestion on what tools you want to learn in the next session?
